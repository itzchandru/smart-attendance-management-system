...
<head>
    <meta charset="UTF-8">
    <title>Select Year to Export Attendance</title>
...
<div class="attendance-card">
    <div class="card-header">
        <i class="fas fa-eye me-2"></i> Export Attendance by Year
    </div>
...
<script>
    document.getElementById("yearForm").addEventListener("submit", function(event) {
        ...
        switch (selectedYear) {
            case "1":
                targetPage = "1st_principal_export_attendance.php";
                break;
            case "2":
                targetPage = "2nd_principal_export_attendance.php";
                break;
            case "3":
                targetPage = "3rd_principal_export_attendance_form.php";
                break;
            case "4":
                targetPage = "4th_principal_export_attendance.php";
                break;
            default:
