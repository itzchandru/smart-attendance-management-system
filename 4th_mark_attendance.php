...
// Fetch subjects (assuming subjects are not year-specific)
$subjectQuery = "SELECT subject_code, subject_name FROM fourth_subjects"; 
$subjectResult = $conn->query($subjectQuery);

// Fetch only 1st year students
$studentQuery = "SELECT roll_number, name FROM fourth_students WHERE year = '4'";
...
<body>
    <div class="container p-3 p-md-4">
        ...
        <form action="4th_submit_attendance.php" method="POST" id="attendanceForm">
            <!-- Basic Info Row -->
            <div class="row">
                <!-- Select Date -->
