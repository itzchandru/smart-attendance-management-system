...
$studentsQuery = "SELECT DISTINCT roll_number, name FROM second_students ORDER BY roll_number ASC";
$studentsResult = $conn->query($studentsQuery);

$subjectsQuery = "SELECT DISTINCT subject_code, subject_name FROM second_attendance ORDER BY subject_name ASC";
...
<div class="container-custom">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <a href="principal_alt_dashboard.php" class="btn btn-outline-secondary btn-sm">
  ...
  <form action="2nd_export_attendance_word.php" method="GET">
    <!-- Student Filter -->
...
<script>
  ...
  function previewData() {
    ...
    // Open in same window
    window.location.href = `2nd_principal_preview_attendance.php?${params}`;
  }
</script>
</body>
</html>
