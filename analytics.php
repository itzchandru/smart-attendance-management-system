...
$subject_result = $conn->query("SELECT DISTINCT subject_name FROM attendance ORDER BY subject_name");

// Fetch all students for dropdown
$student_result = $conn->query("SELECT DISTINCT roll_number, student_name FROM attendance ORDER BY student_name");
