...
$subject_query = "SELECT DISTINCT subject_name FROM fourth_attendance ORDER BY subject_name";
$subject_result = $conn->query($subject_query);

$year_query = "SELECT DISTINCT YEAR(date) as year FROM fourth_attendance ORDER BY year DESC";
...
$base_query = "FROM fourth_attendance 
               JOIN fourth_students ON fourth_attendance.roll_number = fourth_students.roll_number 
               WHERE 1=1";

if ($search_name) {
    $base_query .= " AND fourth_students.name LIKE '%$search_name%'";
}
if ($search_roll) {
    $base_query .= " AND fourth_students.roll_number LIKE '%$search_roll%'";
}
if ($search_subject) {
    $base_query .= " AND fourth_attendance.subject_name = '$search_subject'";
}
if ($search_date) {
    $base_query .= " AND fourth_attendance.date = '$search_date'";
}
if ($search_status) {
    $base_query .= " AND fourth_attendance.status = '$search_status'";
}
if ($search_week) {
    $base_query .= " AND WEEK(fourth_attendance.date, 1) = WEEK('$search_week', 1) AND YEAR(fourth_attendance.date) = YEAR('$search_week')";
}
if ($search_month && $search_year) {
    $base_query .= " AND MONTH(fourth_attendance.date) = '$search_month' AND YEAR(fourth_attendance.date) = '$search_year'";
}

$attendance_query = "SELECT fourth_students.name AS student_name, fourth_students.roll_number, 
                            fourth_attendance.subject_name, fourth_attendance.status, fourth_attendance.date 
                     $base_query 
                     ORDER BY fourth_attendance.date DESC, fourth_students.name ASC
        ...
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-end">
                    ...
                    <a href="4th_principal_view_attendance.php" class="btn btn-outline-secondary">
