...
<head>
    <meta charset="UTF-8">
    <title>Select Year to View Attendance</title>
...
<div class="attendance-card">
    <div class="card-header">
        <i class="fas fa-eye me-2"></i> View Attendance by Year
    </div>
...
<script>
    document.getElementById("yearForm").addEventListener("submit", function(event) {
        ...
        switch (selectedYear) {
            case "1":
                targetPage = "1st_principal_view_attendance.php";
                break;
            case "2":
                targetPage = "2nd_principal_view_attendance.php";
                break;
            case "3":
                targetPage = "principal_view_attendance.php";
                break;
            case "4":
                targetPage = "4th_principal_view_attendance.php";
                break;
            default:
