...
// Fetch subjects
$subjectQuery = "SELECT subject_code, subject_name FROM first_subjects"; 
$subjectResult = $conn->query($subjectQuery);

// Fetch students
$studentQuery = "SELECT roll_number, name FROM first_students";
...
<body>
    <div class="container p-3 p-md-4">
        ...
        <form action="1st_submit_attendance.php" method="POST" id="attendanceForm">
            <!-- Basic Info Row -->
            <div class="row">
                <!-- Select Date -->
