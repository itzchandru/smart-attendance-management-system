...
$studentsQuery = "SELECT DISTINCT roll_number, name FROM first_students ORDER BY roll_number";
$studentsResult = $conn->query($studentsQuery);

$subjectsQuery = "SELECT DISTINCT subject_code, subject_name FROM first_attendance ORDER BY subject_name";
...
<div class="container-custom">
  ...
  <form action="1st_export_attendance_word.php" method="GET">
    <!-- Student Filter -->
...
<script>
  ...
  function previewData() {
    ...
    // Open in same window
    window.location.href = `1st_principal_preview_attendance.php?${params}`;
  }
</script>
</body>
</html>
