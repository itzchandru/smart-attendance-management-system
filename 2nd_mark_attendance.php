...
// Fetch subjects
$subjectQuery = "SELECT subject_code, subject_name FROM second_subjects"; 
$subjectResult = $conn->query($subjectQuery);

// Fetch students
$studentQuery = "SELECT roll_number, name FROM second_students";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insertQuery = "
        INSERT INTO {$year}_attendance (date, roll_number, student_name, time_slot, subject_code, subject_name, status, marked_by, faculty_id, year)
...
<body>
    <div class="container p-3 p-md-4">
        ...
        <form action="2nd_submit_attendance.php" method="POST" id="attendanceForm">
            <!-- Basic Info Row -->
            <div class="row">
                <!-- Select Date -->
