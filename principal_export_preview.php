...
if (!empty($student)) {
    $query .= " AND students.roll_number = '$student'";
}
if (!empty($subject)) {
    $query .= " AND attendance.subject_code = '$subject'";
}
if (!empty($startDate) && !empty($endDate)) {
    $query .= " AND attendance.date BETWEEN '$startDate' AND '$endDate'";
}
...
<body class="gradient-bg">
    <div class="container-custom mt-5">
        ...
        <div class="text-center mt-4">
            <a href="principal_export.php" class="btn btn-primary">⬅️ Back to Filters</a>
        </div>
    </div>
</body>
</html>